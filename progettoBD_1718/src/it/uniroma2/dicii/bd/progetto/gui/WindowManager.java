...
public class WindowManager {
	...
	private static final String LABEL_EXCEPTION_DESCRIPTION = "Eccezione riscontrata:";
	...
	public void openDetailedErrorWindow(String message, Exception e) {
        ...
        Label label = new Label(LABEL_EXCEPTION_DESCRIPTION);
